...
public Evento(int capacidadEvento, String tipoEvento,String fechaEvento, Venue venueAsociado, double cobroEmision, int porcentajeServicio, Promotor promotor) 
{
